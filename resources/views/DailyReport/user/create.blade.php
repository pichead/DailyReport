  ...
  <form method="POST" action="{{asset('create')}}" enctype="multipart/form-data">
    ...
    @csrf
            ...
            <div class="form-row mx-auto col-12 col-md-9 px-0 px-auto">
              ...
              <div class="form-group col mx-auto">
                <label>Tag ผู้ใช้งาน</label>
                  @php
                    $user =  App\Models\User::whereIn('type',array(1,0))->get();
                  @endphp
                <select name="tag[]" id="usertag" data-placeholder="Tag..." multiple class="py-2 form-control chosen-select" tabindex="-1">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    ...
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W1_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W1_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W1_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W2_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W2_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W2_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>              
              </div>
            </div>
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W3_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W3_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W3_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W4_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W4_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W4_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W5_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W5_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W5_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W6_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W6_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W6_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W7_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W7_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W7_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W8_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W8_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W8_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W9_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W9_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W9_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W10_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W10_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W10_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W11_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W11_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W11_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W12_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W12_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W12_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W13_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W13_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W13_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W14_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W14_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W14_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 col-md-3 row mx-auto mr-3">
                    <label class="col-4 col-md-5 p-0">เวลาเริ่ม</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W15_time_start">
                  </div>
                  <div class="form-group col-6 col-md-3 row mx-auto  pr-2  ">
                    <label class="col-4 col-md-5 p-0">สิ้นสุด</label>
                    <input class="col-8 col-md-7 p-0 form-control" type="text" name="W15_time_end">
                  </div>
                  <div class="form-group col-12 col-md mx-auto ml-md-4">
                  <input class="form-control" name="W15_ref" placeholder="ผู้มอบหมายงาน">
                </div>
                </div>
