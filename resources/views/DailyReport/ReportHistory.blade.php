                            ...
                            <thead>
                                ...
                                <tbody >
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work1}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work2}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work3}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work4}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work5}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work6}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work7}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work8}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work9}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work10}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work11}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work12}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work13}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work14}}</td>
                                  ...
                                  <tr class="row mx-auto">
                                    ...
                                    <td class="col-5">{{$report_row->Work15}}</td>
