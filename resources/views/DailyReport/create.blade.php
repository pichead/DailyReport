  ...
  <form method="POST" action="{{asset('create')}}">
    @csrf
            ...
            <div class="form-row mx-auto col-12 col-md-9 px-0 px-auto">
              ...
              <input class="form-control" style="display:none;" type="text" name="Work_status" value="ยังไม่ได้ approve">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0">
              ...
              <div class="form-group col-md-7 col-12 mx-auto">

                  <textarea class="form-control" id="message" name="Work1" rows="5"></textarea>
              </div>
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W1_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W1_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W2_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W2_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W3_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W3_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W4_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W4_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W5_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W5_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W6_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W6_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W7_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W7_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W8_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W8_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W9_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W9_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w10" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W10_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W10_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W11_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W11_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W12_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W12_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W13_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W13_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W14_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W14_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
            ...
            <div class="form-row col-12 col-md-9 mx-auto py-3 px-0 w15" style="display:none;">
              ...
              <div class="form-group col-md-5 col-12 mx-auto p-0">
                <div class="form-row mx-auto">
                  <div class="form-group col-6 row mx-auto">
                    <label class="col-5 p-0">เวลาเริ่ม</label>
                    <input class="col-7 p-0 form-control" type="time" name="W15_time_start"></input>
                  </div>
                  <div class="form-group col-6 row mx-auto  pr-0">
                    <label class="col-5 p-0">สิ้นสุด</label>
                    <input class="col-7 p-0 form-control" type="time" name="W15_time_end"></input>
                  </div>
                </div>
                <div class="form-group col mx-auto p-0">
